(()=>{
 ...
 function ensureShell(){
  if(!document.querySelector('header')){
   ...
   header.innerHTML='<div class="container nav"><a class="brand" href="/"><span class="mark"></span>Hiperfoco</a><nav class="menu"><a href="/reviews/">Reseñas</a><a href="/categoria/">Categorías</a><a href="/comparativas/">Comparativas</a><a href="/guias/">Guías</a><a href="/regalos/">Regalos</a><a href="/selecciones/">Selecciones</a><a href="/metodologia.html">Cómo analizamos</a><a class="support" href="/apoyar.html">♡ Apóyanos</a></nav><button class="mobile-toggle" data-menu aria-label="Abrir menú" aria-expanded="false"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7h16M4 12h16M4 17h16"/></svg></button></div><nav class="mobile-panel" data-mobile><a href="/reviews/">Reseñas</a><a href="/categoria/">Categorías</a><a href="/comparativas/">Comparativas</a><a href="/guias/">Guías</a><a href="/regalos/">Regalos</a><a href="/selecciones/">Selecciones</a><a href="/metodologia.html">Cómo analizamos</a></nav>';
   document.body.prepend(header);
  }
  if(!document.querySelector('footer')){
   const footer=document.createElement('footer');footer.className='footer';
   footer.innerHTML='<div class="container footer-grid"><div><a class="brand" href="/"><span class="mark"></span>Hiperfoco</a><p>Nos obsesionamos.<br>Tú compras mejor.</p></div><div><b>Explorar</b><a href="/reviews/">Reseñas</a><a href="/categoria/">Categorías</a><a href="/comparativas/">Comparativas</a><a href="/guias/">Guías</a></div><div><b>Descubrir</b><a href="/regalos/">Regalos</a><a href="/selecciones/">Por necesidad</a><a href="/metodologia.html">Metodología</a></div><div><b>Transparencia</b><a href="/politica-editorial.html">Política editorial</a><a href="/financiacion.html">Cómo nos financiamos</a><a href="/apoyar.html">Apoyar</a></div><div><b>Legal</b><a href="/contacto.html">Contacto</a><a href="/privacidad.html">Privacidad</a><a href="/cookies.html">Cookies</a></div></div>';
 ...
 function init(){
  ...
  if(!nav)return;
  if(toggle&&mobilePanel&&!toggle.dataset.shellMenu){toggle.dataset.shellMenu='1';toggle.addEventListener('click',()=>{const open=mobilePanel.classList.toggle('open');toggle.setAttribute('aria-expanded',String(open));});}
  ...
  if(mobilePanel){
   ...
   if(!mobilePanel.querySelector('a[href*="selecciones"]')){const a=document.createElement('a');a.href='/selecciones/';a.textContent='Selecciones';mobilePanel.appendChild(a);}
